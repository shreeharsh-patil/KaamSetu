...
export const SEED_JOBS: SeedJobDef[] = [
  ...
  // ───────────────────────── MATCHING (4) ─────────────────────────
  { key: 'matching-1', customer: 2, town: 'PANAJI', category: 'electrician', skills: ['fan-repair'], title: 'Bedroom ceiling fan not working', description: 'Fan hums but doesn’t spin. Capacitor probably dead.', urgency: 'TODAY', estimatedPrice: 450, status: 'MATCHING', createdMinutesAgo: 35, scenario: 'multiple-nearby-electricians' },
  ...
  { key: 'offered-2', customer: 2, town: 'PANAJI', category: 'electrician', skills: ['mcb-repair'], title: 'MCB tripping repeatedly', description: 'Living room MCB trips whenever the geyser switches on.', urgency: 'TODAY', estimatedPrice: 500, status: 'OFFERED', createdMinutesAgo: 40, assignedAfterMinutes: 10, workerN: 2 },
  { key: 'offered-3', customer: 6, town: 'PONDA', category: 'electrician', skills: ['wiring'], title: 'New socket for kitchen appliance', description: 'Need a 16A socket added in the kitchen.', urgency: 'FLEXIBLE', estimatedPrice: 550, status: 'OFFERED', createdMinutesAgo: 55, assignedAfterMinutes: 12, workerN: 18, scenario: 'offline-worker-offered — worker 18 is OFFLINE, offer still pending response' },
  ...
  { key: 'accepted-3', customer: 5, town: 'CALANGUTE', category: 'electrician', skills: ['light-installation'], title: 'Install two wall lights', description: 'Two wall lamps bought from the shop, need mounting and wiring.', urgency: 'FLEXIBLE', estimatedPrice: 600, status: 'ACCEPTED', createdMinutesAgo: 180, assignedAfterMinutes: 25, workerN: 12 },
  ...
  // ───────────────────────── ARRIVED (2) ─────────────────────────
  { key: 'arrived-demo', customer: 1, town: 'PANAJI', category: 'electrician', skills: ['socket-repair'], title: 'Sparking socket in bedroom', description: 'Socket sparked once when plugging in the charger. Smells slightly burnt.', urgency: 'EMERGENCY', estimatedPrice: 500, status: 'ARRIVED', createdMinutesAgo: 55, assignedAfterMinutes: 10, workerN: 2, scenario: 'worker-on-site — Amit Naik arrived' },
  ...
  { key: 'done-2', customer: 2, town: 'PANAJI', category: 'electrician', skills: ['fan-repair'], title: 'Hall fan making noise', description: 'Bearing noise at high speed.', urgency: 'FLEXIBLE', estimatedPrice: 300, status: 'COMPLETED', createdMinutesAgo: 7200, assignedAfterMinutes: 35, workerN: 2 },
  { key: 'done-3', customer: 3, town: 'PORVORIM', category: 'electrician', skills: ['switch-repair'], title: 'Two switches replaced', description: 'Switch plates cracked.', urgency: 'FLEXIBLE', estimatedPrice: 250, status: 'COMPLETED', createdMinutesAgo: 8640, assignedAfterMinutes: 50, workerN: 2 },
  ...
  { key: 'done-10', customer: 11, town: 'CANDOLIM', category: 'electrician', skills: ['light-installation'], title: 'Garden lights installed', description: 'Four garden pole lights wired.', urgency: 'FLEXIBLE', estimatedPrice: 1200, status: 'COMPLETED', createdMinutesAgo: 18720, assignedAfterMinutes: 50, workerN: 12 },
  ...
  // ───────────────────────── CANCELLED (3) ─────────────────────────
  { key: 'cancelled-1', customer: 2, town: 'PANAJI', category: 'electrician', skills: ['wiring'], title: 'Additional power point in garage', description: 'Customer found a local electrician instead.', urgency: 'FLEXIBLE', estimatedPrice: 600, status: 'CANCELLED', createdMinutesAgo: 4320, scenario: 'cancelled-before-matching' },
  ...
  // ───────────────────────── EXPIRED (2) ─────────────────────────
  { key: 'expired-1', customer: 9, town: 'COLVA', category: 'electrician', skills: ['fan-repair'], title: 'Fan capacitor replacement', description: 'No workers accepted within the offer window.', urgency: 'TODAY', estimatedPrice: 300, status: 'EXPIRED', createdMinutesAgo: 2880, scenario: 'no-eligible-worker-nearby — led to expiry' },
